...
## 📰 Editorial 1: Unkind cuts: On the Telangana and Karnataka electoral rolls
```json
{
  "editorial_metadata": {
  ...
  "editorial_vocabulary": [
    {
      "order_index": 1,
      "word_or_phrase": "disenfranchisement",
...
## 📰 Editorial 2: Deferred rivalry: On the U.S. Open
```json
{
  "editorial_metadata": {
